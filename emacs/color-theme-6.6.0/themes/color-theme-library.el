...
(defun color-theme-charcoal-black ()
  ...
  (color-theme-install
   '(color-theme-charcoal-black
     ...
     (Info-title-3-face ((t (:bold t :weight bold :family "helv" :height 1.2))))
     (Info-title-4-face ((t (:bold t :family "helv" :weight bold))))
     (rst-level-1-face ((t (:background "Grey75" :foreground "Grey12"))))
     (rst-level-2-face ((t (:background "Grey70" :foreground "Grey12"))))
     (rst-level-3-face ((t (:background "Grey65" :foreground "Grey12"))))
     (rst-level-4-face ((t (:background "Grey60" :foreground "Grey12"))))
     (rst-level-5-face ((t (:background "Grey55" :foreground "Grey12"))))
     (rst-level-6-face ((t (:background "Grey50" :foreground "Grey12"))))
     (bg:erc-color-face0 ((t (nil))))
     (bg:erc-color-face1 ((t (nil))))
     (bg:erc-color-face10 ((t (nil))))
     (bg:erc-color-face11 ((t (nil))))
